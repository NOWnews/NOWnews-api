...
module.exports = new cron.CronJob({
    ...
    onTick: async() => {
        try {
            ...
            // if (!feedUrl || feedUrl === '') {
            //     console.log('中央社 RSS Feed 鉅亨網沒有設定');
            //     return;
            // }
            ...
            for (let [index, value] of newsList.entries()) {
                ...
                let newsOptions = {
                    ...
                    MainPhoto: '511000000000000000000010',
                    MainVideo: null,
