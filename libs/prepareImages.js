...
module.exports = async (news) => {
    try {
        ...
        let checkstatus = await Promise.all([
            ...
            axios.get(`http://35.201.254.162:8877/?w=750&q=70&src=${news.MainPhoto.url}`),
            ...
            axios.get(`http://35.201.254.162:8877/?w=320&q=70&src=${news.MainPhoto.url}`),
            ...
            axios.get(`http://35.201.178.13:8877/?w=1440&q=85&src=${news.MainPhoto.url}`),
            axios.get(`http://35.201.178.13:8877/?w=1242&q=85&src=${news.MainPhoto.url}`),
            axios.get(`http://35.201.178.13:8877/?w=1125&q=85&src=${news.MainPhoto.url}`),
            axios.get(`http://35.201.178.13:8877/?w=1080&q=85&src=${news.MainPhoto.url}`),
            axios.get(`http://35.201.178.13:8877/?w=750&q=70&src=${news.MainPhoto.url}`),
            ...
            axios.get(`http://35.201.178.13:8877/?w=320&q=70&src=${news.MainPhoto.url}`),
